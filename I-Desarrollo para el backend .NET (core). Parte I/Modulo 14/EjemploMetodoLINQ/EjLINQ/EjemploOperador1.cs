    ...
    internal class EjemploOperador1
    {
        ...
        internal void Ejecutar()
        {
            ...
            IEnumerable<Empleado> Empleados = new List<Empleado>()
         {
            ...
            // ordenado por nombre
            List<string> empleadosMadrid = Empleados
                                             .Where(empleado => (empleado.Ciudad == "Madrid")
                                                        && empleado.Apellidos.ToLower().Contains("a")
                                                    )
                                             .OrderByDescending(empleado => empleado.Nombre)
            ...
            List<string> empleadosMadridConsulta = (from empleado in Empleados
